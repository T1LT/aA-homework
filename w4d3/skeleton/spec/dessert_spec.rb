...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new('brownie', 'abc', chef) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      ...
      expect(brownie.ingredients).to eq(["egg", "flour", "cocoa"])
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      brownie.add_ingredient("cocoa")
      brownie.mix!
      expect(brownie.ingredients.to_set).to eq(["egg", "flour", "cocoa"].to_set)
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(brownie.serve).to eq("Chef Mark the Great Baker has made 50 brownies!")
    end
  end
